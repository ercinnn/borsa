...
/// basamak görünene kadar artırılır. `monthly_low_checker.dart`'taki
/// bildirim mesajı için yazıldı; `toStringAsFixed(4)` sabit basamak
/// kullandığından çok küçük kripto fiyatlarında "0.0000" gösteriyordu.
